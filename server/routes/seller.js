...
// Banner
router.get("/banner/:id", sellerController.getBanners);
router.post("/banner/:id", upload.single("image"), sellerController.postBanner);
router.put("/banner/:id/:bannerId", sellerController.updateBannerStatus);
router.delete("/banner/:id/:bannerId", sellerController.deleteBanner);
