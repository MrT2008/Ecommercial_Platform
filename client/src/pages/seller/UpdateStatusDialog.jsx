...
const statuses = ['Pending', 'Processing', 'Canceled', 'Delivered'];

const UpdateStatusDialog = ({ currentStatus, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-xl p-6">
        ...
        <div className="flex justify-end gap-4">
          ...
          <SecondaryButton title="Save" onClick={() => onSave(selectedStatus)} />
        </div>
      </div>
    </div>
  );
