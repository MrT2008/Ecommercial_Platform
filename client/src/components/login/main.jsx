  ...
  return (
    <div className="flex items-center h-screen mt-10">
        <div className="h-full">
            <img src={template} alt="template-login" className="w-full h-full"/>
        </div>
        <div className="flex flex-col justify-center w-1/2 mr-auto ml-auto">
            ...
            <form className='flex flex-col justify-center items-start mr-auto ml-auto'>
                ...
                <Button text='Log in' otherClassName='login mt-5 w-70' type='submit'/>
                <Button text='Log in with Google' otherClassName='google mt-5 w-70 border' type=''/>
            </form>
        </div>
    </div>
  );    
