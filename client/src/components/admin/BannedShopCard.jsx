      ...
      <div className="shop-item flex items-center py-4 border-b border-gray-100 last:border-b-0">
        ...
        <div className="shop-details flex-1">
          ...
          <div className="shop-info flex items-center text-sm text-gray-600 mb-1 flex-wrap">
            <span className="shop-id mr-4">Shop ID: {shop.shopId}</span>
        ...
        <button className="unban-btn bg-white text-green-500 border border-green-500 rounded px-4 py-1.5 text-sm flex items-center hover:bg-green-50 transition-all">
